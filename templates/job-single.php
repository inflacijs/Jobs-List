...
<?php include 'inc/header.php' ?> 
    ...
    <ul class="list-group">
        <li class="list-group-item"><strong>Company:</strong> <?php echo $job->company ?></strong></li>
        <li class="list-group-item"><strong>Salary:</strong> <?php echo $job->salary ?></strong></li>
